...
public final class SimpleGuiBuilder implements SlotHolder {
    ...
    private List<ClickAction> closeActions = null;

    public SimpleGuiBuilder(Menu menu, MenuType<?> type, boolean manipulatePlayerSlots) {
    ...
    public SimpleGui build(ServerPlayer player) {
        SimpleGui gui = new SimpleGui(this.menu, this.type, player, this.includePlayer, this.closeActions);
    ...
    public void setCloseActions(@Nullable List<ClickAction> actions) {
