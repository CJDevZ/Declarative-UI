...
public class CommandArgumentProviders {
    ...
    public static final MapCodec<FloatArgumentType> FLOAT_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final MapCodec<DoubleArgumentType> DOUBLE_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final MapCodec<IntegerArgumentType> INTEGER_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final MapCodec<LongArgumentType> LONG_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final MapCodec<EntityArgument> ENTITY_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final MapCodec<StringArgumentType> STRING_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            STRING_TYPE_CODEC.fieldOf("variant").forGetter(StringArgumentType::getType)
    ).apply(instance, StringArgumentTypeAccessor::create));
    public static final MapCodec<TimeArgument> TIME_ARGUMENT_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            Codec.INT.optionalFieldOf("minimum", 0).forGetter(timeArgument -> ((TimeArgumentAccessor) timeArgument).getMinimum())
    ).apply(instance, TimeArgument::time));
    public static final MapCodec<ScoreHolderArgument> SCORE_HOLDER_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            Codec.BOOL.fieldOf("multiple").forGetter(scoreHolderArgument -> ((ScoreHolderArgumentAccessor) scoreHolderArgument).isMultiple())
    ).apply(instance, ScoreHolderArgument::new));

    public static void registerStable(Class<? extends ArgumentType<?>> argumentClass, ArgumentType<?> stableInstance) {
        register(argumentClass, RecordCodecBuilder.mapCodec(instance -> instance.stable(stableInstance)));
    }

    public static void register(Class<? extends ArgumentType<?>> argumentClass, MapCodec<? extends ArgumentType<?>> mapCodec) {
