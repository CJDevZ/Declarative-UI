...
public final class DeclarativeUIRegistries {
    ...
    public static final ResourceKey<Registry<CommandArgumentProvider>> COMMAND_ARGUMENT_PROVIDER = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MOD_ID, "command_argument_provider"));
